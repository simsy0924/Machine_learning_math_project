...
//   special: 'repeat' | 'setVariable'                      (optional)
//
// `special` blocks are not ordinary functions of their inputs — the evaluator in
// js/evaluate.js drives them. Everything else is a pure forward function; backward
// formulas are written by the user in js/manual-backprop.js, never derived here.
